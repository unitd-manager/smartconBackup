...
const EditCostingSummaryModal = ({
  ...
  const handleCalc=()=>{
    ...
    editCostingSummaryData.allValues.no_of_days_worked *
    editCostingSummaryData.allValues.labour_rates_per_day;
  }
                    ...
                    <Row>
                      <Col md="4">
                        <FormGroup>
                          ...
                          <Input
                            type="number"
                            onChange={(e)=>{handleCostingSummeryInputs(e);handleCalc(e.target.value, costingsummary.no_of_days_worked,costingsummary.labour_rates_per_day,costingsummary.total_labour_charges)}}
                      ...
                      <Col md="4">
                        <FormGroup>
                          ...
                          <Input
                            type="number"
                            onChange={(e)=>{handleCostingSummeryInputs(e);handleCalc(costingsummary.no_of_worker_used,e.target.value,costingsummary.labour_rates_per_day,costingsummary.total_labour_charges)}}
                      ...
                      <Col md="4">
                        <FormGroup>
                          ...
                          <Input
                            type="number"
                            onChange={(e)=>{handleCostingSummeryInputs(e);handleCalc(costingsummary.no_of_worker_used, costingsummary.no_of_days_worked,e.target.value,costingsummary.total_labour_charges,)}}
                      ...
                      <Col md="4">
                        <FormGroup>
                          ...
                          <Input
                            type="number"
                            onChange={(e)=>{handleCostingSummeryInputs(e);}}
                    ...
                    <Col md="4">
                      <FormGroup>
                        ...
                        <Input
                          type="number"
                          disabled
                          onChange={(e)=>{handleCostingSummeryInputs(e);handleCalc(costingsummary.no_of_worker_used, costingsummary.no_of_days_worked,costingsummary.labour_rates_per_day,e.target.value)}}
